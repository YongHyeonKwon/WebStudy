						...
						<!-- Q3. 로그인 기능 만들기 -->
							<li><h5>로그인</h5></li>
								<form action = "Login.do">
									...
									<li><input type="submit" value="LogIn" onclick="return check_login()" class="button fit"></li>
								</form>
						</ul>
						...
						<!-- Q1. 회원가입 기능 만들기 -->
							<li><h5>회원가입</h5></li>
								<form action = "Join.do" method="post" name="Joinform">
									...
									<li><input type="submit" value="JoinUs" onclick="return check_join()" class="button fit"></li>
								</form>
						</ul>
					</nav>			
				<!-- Banner -->
					<section id="banner" class="major">
						<div class="inner">
							...
							<!-- ex) 00님 환영합니다.  -->
								<c:if test="${!empty info}"> <!-- empty -> 값이 있다면 -->
							...
							<div class="content">
								<p>게시판을 이용해보세요 ^^<br></p>
								<ul class="actions">
									<li><a href="goBoard.do" class="button next scrolly">게시판 바로가기</a></li>
								</ul>
							</div>
						</div>
					</section>
							...
							<section id="two">
								<div class="inner">
									<header class="major">
										...
										<c:if test="${!empty info}">
											<h2>${info.email}에게 온 메세지 확인하기</h2>
										</c:if>
										</header>
									<p></p>
									<ul class="actions">
										...
										<!-- Q14. 메시지 전체 삭제 기능 -->								
										<li><a href="AllMsgDel.do" class="button next scrolly">전체삭제하기</a></li>
									</ul>
									<!-- Q13. table형태로 나한테 온 메시지만 가져와서 보여주기 -->
									<!-- 로그인이 된 회원이라면 곧바로 메세지를 가져올 수 있도록 한다! -->
									<%
									...
									<table>
										...
										<c:forEach var="message" items="${list}" varStatus="status">
											<tr>
												...
												<td><a href="OneMsgDel.do?num=${message.num}">삭제</td>
											</tr>
										</c:forEach>									
									</table>
